                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><?php if($no_of_user_products==0){
                                                echo '<button type="button" class="btn btn-primary disabled">Confirm Order</button>';
                                            }else {?><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a><?php } ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
