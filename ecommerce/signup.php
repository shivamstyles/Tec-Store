                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <form method="post" action="user_registration_script.php">
                            ...
                            <div class="form-group"> 
                                <input type="number" class="form-control" name="roll_no" placeholder="Roll No." required="true">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="address" placeholder="Hostel Address" required="true">
                            </div>
                            <div class="form-group">
